...
def gen_newick(q):
    ...
    external_branch_model = scipy.stats.gamma(a=0.50, scale=0.3)
    internal_branch_model = scipy.stats.gamma(a=0.50, scale=0.3)
    expected_mean_pairwise_divergence = scipy.stats.uniform(0.03,0.3).rvs()
